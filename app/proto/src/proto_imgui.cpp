...
/* Description
==============
Prototype to practice and explore usage of DearImGUI library as a part of this
project, in conjunction with SDL2 (Simple DirectMedia Layer 2) and OpenGL3
==============
*/
...
TEST(Proto_ImGUI, Test) { ProtoMain(); }
