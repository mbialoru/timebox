...
bool TimeBox::check_if_using_docker()
{
...
std::string TimeBox::render_nonprintable_characters(const std::string& tr_input_string)
{
  std::string result;
...
std::string TimeBox::timepoint_to_string(const std::chrono::system_clock::time_point t_timepoint)
{
