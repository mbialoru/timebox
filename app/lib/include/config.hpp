...
struct BuildInformation
{
  ...
  static constexpr std::string_view GIT_SHORT_SHA{ "b9901474" };
  ...
  static constexpr std::string_view BUILD_DATE{ "2022-11-25 14:59:46 UTC" };
  static constexpr std::string_view BUILD_HASH{ "86c65b8e25bd4be2fd4429c4ff572c18f41614d1bfc0894bf06af4dda6403b90" };
};
