...
struct BuildInformation
{
  ...
  static constexpr std::string_view GIT_SHORT_SHA{ "e7efa0d4" };
  ...
  static constexpr std::string_view BUILD_DATE{ "2022-11-15 14:21:05 UTC" };
  static constexpr std::string_view BUILD_HASH{ "afd43de22b0624b9729d89f579ee642ee9f6afab381a1111568a804f6c9fa29b" };
};
