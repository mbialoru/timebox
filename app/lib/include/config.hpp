...
struct BuildInformation
{
  ...
  static constexpr std::string_view GIT_SHORT_SHA{ "53d89c0c" };
  ...
  static constexpr std::string_view BUILD_DATE{ "2022-11-14 21:13:46 UTC" };
  static constexpr std::string_view BUILD_HASH{ "3712110d393c3238000117c9fe54c514e37265df20ccb1ffbb70507dbe8c957b" };
};
