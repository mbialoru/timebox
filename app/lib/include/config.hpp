...
struct BuildInformation
{
  ...
  static constexpr std::string_view GIT_SHORT_SHA{ "c3653989" };
  ...
  static constexpr std::string_view BUILD_DATE{ "2023-02-17 09:09:33 UTC" };
  static constexpr std::string_view BUILD_HASH{ "d3b3ef19b8896f0b9cf9783732c69a133ea73a42f194b475e5af10219532b91a" };
};
