...
struct BuildInformation
{
  ...
  static constexpr std::string_view GIT_SHORT_SHA{ "fcc0101e" };
  ...
  static constexpr std::string_view BUILD_DATE{ "2022-11-29 11:18:26 UTC" };
  static constexpr std::string_view BUILD_HASH{ "849a7246138ea2af496f503b3717998a9ac61387d5d1e3977c8e71eb1a736007" };
};
