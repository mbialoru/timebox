...
struct BuildInformation
{
  ...
  static constexpr std::string_view GIT_SHORT_SHA{ "98364e8d" };
  ...
  static constexpr std::string_view BUILD_DATE{ "2022-11-16 14:55:08 UTC" };
  static constexpr std::string_view BUILD_HASH{ "1c725da9c0ae010aa48ad662f7b013010bf4d7d60076455c681262a70cb7291b" };
};
