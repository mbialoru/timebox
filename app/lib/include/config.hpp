...
struct BuildInformation
{
  ...
  static constexpr std::string_view GIT_SHORT_SHA{ "2ab749f1" };
  ...
  static constexpr std::string_view BUILD_DATE{ "2022-12-01 13:54:34 UTC" };
  static constexpr std::string_view BUILD_HASH{ "4eddd06c29dec6bd5c8a45c69267e6d8d867279eb874716fbde61d5352578dd0" };
};
