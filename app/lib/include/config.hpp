...
struct BuildInformation
{
  ...
  static constexpr std::string_view GIT_SHORT_SHA{ "0f04f737" };
  ...
  static constexpr std::string_view BUILD_DATE{ "2022-11-24 12:27:41 UTC" };
  static constexpr std::string_view BUILD_HASH{ "b4fc12fa6e3a61e93201683094dc7b59661c6131b78fa1f3d96c1e25905902a3" };
};
