...
struct BuildInformation
{
  ...
  static constexpr std::string_view GIT_SHORT_SHA{ "cb976080" };
  ...
  static constexpr std::string_view BUILD_DATE{ "2022-11-28 11:35:23 UTC" };
  static constexpr std::string_view BUILD_HASH{ "ec0bf5ea55e7f7edf779b2ac2df145b11938c48ee1e92f5818e4963205e18014" };
};
