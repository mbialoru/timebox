...
struct BuildInformation
{
  ...
  static constexpr std::string_view GIT_SHORT_SHA{ "fc1b732f" };
  ...
  static constexpr std::string_view BUILD_DATE{ "2022-11-16 12:25:07 UTC" };
  static constexpr std::string_view BUILD_HASH{ "7bf2378bc00ef91bcf0e4f7f290109491dfe7386a1ba3fef4e89df246aa80a9d" };
};
