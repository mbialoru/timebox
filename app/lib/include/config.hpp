...
struct BuildInformation
{
  ...
  static constexpr std::string_view GIT_SHORT_SHA{ "f9172743" };
  ...
  static constexpr std::string_view BUILD_DATE{ "2022-11-16 11:01:26 UTC" };
  static constexpr std::string_view BUILD_HASH{ "58f7eeb97a62e123229ab6ae5f66e271612a442ccfc69abf6467abd90fccdd58" };
};
