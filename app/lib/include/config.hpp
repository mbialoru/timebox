...
struct BuildInformation
{
  ...
  static constexpr std::string_view GIT_SHORT_SHA{ "f0d81a79" };
  ...
  static constexpr std::string_view BUILD_DATE{ "2023-02-22 12:42:00 UTC" };
  static constexpr std::string_view BUILD_HASH{ "168d0da8f62ee95b1bd552b37106213765adb049d064e00b4c6c73fa1156f675" };
};
