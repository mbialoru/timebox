...
struct BuildInformation
{
  ...
  static constexpr std::string_view GIT_SHORT_SHA{ "93aa8f9d" };
  ...
  static constexpr std::string_view BUILD_DATE{ "2022-11-23 21:51:50 UTC" };
  static constexpr std::string_view BUILD_HASH{ "b124c3cc2bbc5bc2739dd8b4b7fb249adbbde66cc44d9073f13149ca91710d41" };
};
