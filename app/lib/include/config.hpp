...
struct BuildInformation
{
  ...
  static constexpr std::string_view GIT_SHORT_SHA{ "77b61608" };
  ...
  static constexpr std::string_view BUILD_DATE{ "2023-02-19 16:29:19 UTC" };
  static constexpr std::string_view BUILD_HASH{ "d41a9069b81b2fb3e89c7f86d0d9fa2296cf4afea2f6f7e3e1d05e16e45e8615" };
};
