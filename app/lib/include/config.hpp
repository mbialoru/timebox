...
struct BuildInformation
{
  ...
  static constexpr std::string_view GIT_SHORT_SHA{ "ac554da4" };
  ...
  static constexpr std::string_view BUILD_DATE{ "2023-02-19 16:20:06 UTC" };
  static constexpr std::string_view BUILD_HASH{ "b4783019b68182866abf83774088c7da022d10883c8183927e8e3a14efb8f089" };
};
