...
struct BuildInformation
{
  ...
  static constexpr std::string_view GIT_SHORT_SHA{ "e49be22a" };
  ...
  static constexpr std::string_view BUILD_DATE{ "2022-11-29 10:58:40 UTC" };
  static constexpr std::string_view BUILD_HASH{ "2fdf3acb7a1e7a21514be00e4e9fd5541972ec8a7866380baf64abde0aab25d6" };
};
