...
struct BuildInformation
{
  ...
  static constexpr std::string_view GIT_SHORT_SHA{ "67522889" };
  ...
  static constexpr std::string_view BUILD_DATE{ "2022-11-26 18:14:04 UTC" };
  static constexpr std::string_view BUILD_HASH{ "a4104ccdc2d911aeda6574eb527180144d97747ab35a5612f200d85b4d595ae8" };
};
