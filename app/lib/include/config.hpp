...
struct BuildInformation
{
  ...
  static constexpr std::string_view GIT_SHORT_SHA{ "618eb6ea" };
  ...
  static constexpr std::string_view BUILD_DATE{ "2023-02-17 09:39:11 UTC" };
  static constexpr std::string_view BUILD_HASH{ "817dcf4a389536d59c8d3fcd15d1d9e576d1c0c025106193c6eef267aaded324" };
};
