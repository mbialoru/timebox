...
struct BuildInformation
{
  ...
  static constexpr std::string_view GIT_BRANCH{ "cmake-restructure" };
  static constexpr std::string_view GIT_SHORT_SHA{ "e06aaaa7" };
  ...
  static constexpr std::string_view BUILD_DATE{ "2022-11-26 20:07:37 UTC" };
  static constexpr std::string_view BUILD_HASH{ "7ca5ee1f6921ac15ac299963526e43a967c62b8a654ca8553737fbb80d33690a" };
};
