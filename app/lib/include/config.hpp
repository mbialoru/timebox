...
struct BuildInformation
{
  ...
  static constexpr std::string_view GIT_SHORT_SHA{ "8f15d261" };
  ...
  static constexpr std::string_view BUILD_DATE{ "2022-11-26 21:34:45 UTC" };
  static constexpr std::string_view BUILD_HASH{ "7303e4c2c8d273dba58a5d6cecc0bbe924ef9df0b330bebdd60aec00959ebb60" };
};
