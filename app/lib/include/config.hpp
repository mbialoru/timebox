...
struct BuildInformation
{
  ...
  static constexpr std::string_view GIT_SHORT_SHA{ "392f78d2" };
  ...
  static constexpr std::string_view BUILD_DATE{ "2022-11-11 20:19:41 UTC" };
  static constexpr std::string_view BUILD_HASH{ "68b007ebac73b6e6e1f731af8450b91f3c7193aad0b247108faaf93642546d6f" };
};
