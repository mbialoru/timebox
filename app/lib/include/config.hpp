...
struct BuildInformation
{
  ...
  static constexpr std::string_view GIT_SHORT_SHA{ "e33bd432" };
  ...
  static constexpr std::string_view BUILD_DATE{ "2022-11-29 16:05:19 UTC" };
  static constexpr std::string_view BUILD_HASH{ "4008d124bfc39164ff19327f39141410eea3587c739d910fc9b59539611278b6" };
};
