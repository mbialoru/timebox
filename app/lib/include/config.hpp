...
struct BuildInformation
{
  ...
  static constexpr std::string_view GIT_SHORT_SHA{ "490b6376" };
  ...
  static constexpr std::string_view BUILD_DATE{ "2023-02-17 13:28:59 UTC" };
  static constexpr std::string_view BUILD_HASH{ "93485bdd51e9b6b6bb03ec3b8d7d8d76fd100c4e51d5718a8766e006c2ef992b" };
};
