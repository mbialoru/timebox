...
struct BuildInformation
{
  ...
  static constexpr std::string_view GIT_SHORT_SHA{ "d484a966" };
  ...
  static constexpr std::string_view BUILD_DATE{ "2022-11-29 19:27:30 UTC" };
  static constexpr std::string_view BUILD_HASH{ "f05923190fededbc0d78df349a33e781037df1f5fb874072716a69b97a1e44ba" };
};
