...
struct BuildInformation
{
  ...
  static constexpr std::string_view GIT_SHORT_SHA{ "46fba8d3" };
  ...
  static constexpr std::string_view BUILD_DATE{ "2023-02-15 11:21:18 UTC" };
  static constexpr std::string_view BUILD_HASH{ "4e7aade0186361e830545a0abe4a71d3fc887c935bd0275c7a61b4076755f6cc" };
};
