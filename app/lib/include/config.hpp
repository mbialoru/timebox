...
struct BuildInformation
{
  ...
  static constexpr std::string_view GIT_SHORT_SHA{ "978ea3e3" };
  ...
  static constexpr std::string_view BUILD_DATE{ "2022-12-07 13:02:57 UTC" };
  static constexpr std::string_view BUILD_HASH{ "b3e0068586e838a789eac35259e30a292f5ac6f8c74248287fb6463a4fa07a02" };
};
