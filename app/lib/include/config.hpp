...
struct BuildInformation
{
  ...
  static constexpr std::string_view GIT_SHORT_SHA{ "7bd1e898" };
  ...
  static constexpr std::string_view BUILD_DATE{ "2023-02-19 16:11:30 UTC" };
  static constexpr std::string_view BUILD_HASH{ "30ea63d6a855bba351b70b3981291c9026d3df5dc2ceba0c10dd3aec179d033a" };
};
